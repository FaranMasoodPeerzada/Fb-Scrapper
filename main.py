...
username = '@gmail.com'
password = ''
group_url = 'https://www.facebook.com/groups/your_group_url'
...
def extract_members():
    ...
    while True:
        ...
        # Assuming members' names are in 'span' tags within a certain class
        members = soup.find_all('span', {'class': 'a certain class'})
        for member in members:
            members_list.append(member.text)
